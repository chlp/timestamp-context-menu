Chrome extension helps to display the timestamp in a readable format in the context menu (like "right mouse button"-menu). Just select the timestamp and open the context menu.
